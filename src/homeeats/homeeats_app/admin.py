...
from .models import Cook, Customer, Dish, Dish_Review, Cuisine, Order, Item, Address, User, ShoppingCart, CartItem, RejectReason, CookChangeRequest
...
admin.site.register(CookChangeRequest)